...
namespace CollectApp.Migrations
{
    ...
    [Migration("20251026115522_AlterarParaStringOFieldEntityIdDoModelAuditLog")]
    partial class AlterarParaStringOFieldEntityIdDoModelAuditLog
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CollectApp.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("CollectApp.Models.AuditLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CollectApp.Models.Collect", b =>
                {
                    ...
                    b.HasOne("CollectApp.Models.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("CollectApp.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
